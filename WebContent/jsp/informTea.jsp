                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-lg-offset-3">
                                        ...
                                        <div style="display:flex;justify-content:center;" class="form-group">
                                            <button id="s1" type="button" class="myButton" onclick="view5()">修改</button>
                                        </div>
                                        ...
                                        <br><br>
                                        <div style="display:flex;justify-content:center;" class="form-group">
                                            <button id="s2" style="display:none;" type="button" class="myButton1" onclick="insertInfoTea(${id})">确认</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        function insertInfoTea(id) {
            ...
            if (gnl==true) {
                ...
                $.ajax({
                    type:"post",
                    url:"http://localhost:8080/kczl/insertinfotea?id="+id,
