                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card m-b-30">
                            <div class="card-body">
                                <h4 class="mt-0 header-title" style="margin-left:10px;">新增教师信息</h4>
                                <div class="row">
                                    <div class="col-lg-6 col-lg-offset-3">
                                        <form id="addtea" target="_self">
                                            ...
                                            <div class="RadioStyle">
                                            	...
                                            	联系方式：<input name="contact" class="form-control" type="text" value=""><br>
                                            	职称：<br>
                                            	<div class="RadioStyle">
                                                <div class="Block PaddingL">
                                            ...
                                            <div style="display:flex;justify-content:center;" class="form-group">
                                                <input  class="myButton" value="添加" type="button" onclick="addTea()">
                                            </div>
                                        </form>
                                    </div>
                                </div>
    ...
    <script>
        function addTea() {
            ...
            if (gnl==true){
                $.ajax({
                    type:"post",
                    url:"http://localhost:8080/kczl/addtea",
