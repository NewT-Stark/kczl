...
<html>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card m-b-30">
                            <div class="card-body">
                                <h4 class="mt-0 header-title" style="margin-left:10px;">年级信息</h4>
                                <div class="row">
                                    <div class="col-lg-6 col-lg-offset-3">
                                        <table id="table1" class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                            <c:forEach items="${admgra}" var="gra">
                                                <tr>
                                                    <td>${gra.id}</td>
                                                    <td>${gra.name}</td>
                                                    <td>${gra.college_id}</td>
                                                    <td>${gra.pro_id}</td>
                                                </tr>
                                            </c:forEach>
                                            </tbody>
                                        ...
                                        <div style="display:flex;justify-content:center;" class="form-group">
                                            <button id="s1" type="button" class="myButton" onclick="view4()">修改</button>
                                        </div>

                                        <input id="a1" style="display:none;background-color:#8ad4ed;" class="col-lg-6" type="button" value="+" onclick="ar4()" />
                                        <input id="d1" style="display:none;background-color:#ed7676;" class="col-lg-6" type="button" value="-" onclick="del4()" />
                                        <br><br>
                                        <div style="display:flex;justify-content:center;" class="form-group">
                                            <button id="s2" style="display:none;" type="button" class="myButton1" onclick="insertGra()">确认</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        function ar4() {
            var tr="<tr><td name='id'><input type='text' /></td><td name='name'></td><td name='college_id'></td><td name='pro_id'></td></tr>";
            $("#table1").append(tr);
            $("td").click(tdclick4);
        }
        ...
        function insertGra() {
            ...
            if (gnl==true) {
                ...
                $.ajax({
                    type:"post",
                    url:"http://localhost:8080/kczl/insertgra",
