                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card m-b-30">
                            <div class="card-body">
                                <h4 class="mt-0 header-title" style="margin-left:10px;">学院信息</h4>
                                <div class="row">
                                    <div class="col-lg-6 col-lg-offset-3">
                                        <table id="table1" class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                            <c:forEach items="${admcol}" var="col">
                                                <tr>
                                                    <td>${col.id}</td>
                                                    <td>${col.name}</td>
                                                </tr>
                                        ...
                                        <div style="display:flex;justify-content:center;" class="form-group">
                                            <button id="s1" type="button" class="myButton" onclick="view1()">修改</button>
                                        </div>

                                        <input id="a1" style="display:none;background-color:#8ad4ed;" class="col-lg-6" type="button" value="+" onclick="ar1()" />
                                        <input id="d1" style="display:none;background-color:#ed7676;" class="col-lg-6" type="button" value="-" onclick="del1()" />
                                        <br><br>
                                        <div style="display:flex;justify-content:center;" class="form-group">
                                            <button id="s2" style="display:none;" type="button" class="myButton1" onclick="insertCol()">确认</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        function insertCol() {
            ...
            if (gnl==true) {
                ...
                $.ajax({
                    type:"post",
                    url:"http://localhost:8080/kczl/insertcol",
