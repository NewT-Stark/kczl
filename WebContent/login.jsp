...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="bootstrap/css/style.default.css" id="theme-stylesheet" />
    ...
    <body>
                    ...
                    <div class="row">
                        <div style="height:400px;margin-left:300px;" class="col-lg-6 bg-white">
                            <div class="form d-flex align-items-start">
                                <div class="content">
                                    <form method="post" action="login" class="form-validate" id="loginFrom" onsubmit="check_login()">
        ...
        <script type="text/javascript" charset="utf-8" src="bootstrap/js/jquery.validate.min.js"></script><!--表单验证-->
        <!-- Main File-->
        <script type="text/javascript" charset="utf-8" src="bootstrap/js/front.js"></script>
        <script>
